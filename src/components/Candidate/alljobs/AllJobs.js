...
import './AllJob.css'; // Assuming you have a CSS file for styling
...
const AllJobs = () => {
    ...
    try {
        const response = await axios.get('http://localhost:8000/auth/alljobs/');
    ...
    return (
        ...
        <div className="all-jobs-container">
            <h1 className="all-jobs-title">All Job Openings</h1>
